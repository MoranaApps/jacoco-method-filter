...
/** Embedded default rules templates for jmfInitRules task. */
object DefaultRulesTemplates {

  /** 
   * Default rules for Scala-only projects.
   * Based on integration/jmf-rules_for_scala_project.txt
   */
  val scala: String = """# jacoco-method-filter — Default Rules & HowTo (Scala)
# [jmf:1.0.0]
#
...
"""
   ...
   * Based on rules/coverage-rules.sample.txt
   */
  val scalaJava: String = """# jacoco-method-filter — Default Rules & HowTo (Scala + Java)
#
# This file defines which methods should be annotated as *Generated so JaCoCo ignores them.
# One rule per line.
#
...
# ─────────────────────────────────────────────────────────────────────────────
# DEFAULT RULES (start here; replace YOUR.PACKAGE.ROOT)
# ─────────────────────────────────────────────────────────────────────────────
# SECTION: CONSERVATIVE (safe starters; mainly compiler/boilerplate)
...
YOUR.PACKAGE.ROOT.*#*(*)  synthetic name-contains:$anonfun$  id:scala-anonfun
YOUR.PACKAGE.ROOT.*#*(*)  synthetic                        id:synthetic-generic

# ─────────────────────────────────────────────────────────────────────────────
# SECTION: STANDARD (enable after verifying impact)

# Scala product API beyond model (uncomment if polluting)
# YOUR.PACKAGE.ROOT.*#productIterator()                    id:prod-iter
# YOUR.PACKAGE.ROOT.*#canEqual(*)                          id:prod-canequal

# Scala 2 trait init stub
# YOUR.PACKAGE.ROOT.*#<$init$>(*)                         id:trait-init

# Java generics bridge methods (safe)
YOUR.PACKAGE.ROOT.*#*(*)  bridge                          id:java-bridge

# Java 8+ lambdas named "lambda$..."
YOUR.PACKAGE.ROOT.*#*(*)  synthetic name-starts:lambda$   id:java-lambda

# Java synthetic accessors (compiler-generated)
YOUR.PACKAGE.ROOT.*#*(*)  synthetic name-starts:access$   id:java-accessor

# Example return-type constraint (keep commented until you need it)
...
# Lombok/Beans-style accessors – restrict to DTO-only packages
# YOUR.PACKAGE.ROOT.dto.*#get*(*)     public               id:lombok-getter
# YOUR.PACKAGE.ROOT.dto.*#is*(*)      public               id:lombok-boolean
# YOUR.PACKAGE.ROOT.dto.*#set*(*)     public               id:lombok-setter
# Java Records: component accessors (often fine to count; usually leave off)
# YOUR.PACKAGE.ROOT.dto.*#*()                              id:record-components

# Wider companion apply/unapply (ONLY if you're sure)
# YOUR.PACKAGE.ROOT.*$*#apply(*)                           id:wide-apply
# YOUR.PACKAGE.ROOT.*$*#unapply(*)                         id:wide-unapply

# Fluent builder/client methods (consider ret: to restrict to clients)
# YOUR.PACKAGE.ROOT.builder.*#with*(*)                     id:builder-with
# YOUR.PACKAGE.ROOT.client.*#with*(*)  ret:Lcom/api/client/*  id:client-fluent

# ─────────────────────────────────────────────────────────────────────────────
# SECTION: GLOBAL (temporary; use with --dry-run only)

# All anonfun matches under your root
# *#*(*)  name-contains:$anonfun$        id:global-anonfun

# All synthetic methods (broad; do not keep enabled)
# *#*(*)  synthetic                      id:global-synthetic

# *#*(*)  synthetic                      id:global-synthetic
# *#*(*)  bridge                         id:global-bridge
# *#*(*)  synthetic name-contains:$anonfun$  id:global-anonfun
"""
}
